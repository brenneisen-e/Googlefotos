...
if not exist "temp_analyze\" goto :no_temp
...
if errorlevel 1 goto :pick_failed
...
echo   4. Datei speichern und Notepad schliessen
...
echo Bitte zuerst start.bat laufen lassen damit die ZIPs entpackt werden.
pause
exit /b 1
